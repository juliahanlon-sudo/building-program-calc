...
const SPACE_GROUPS = [
  ...
  { id:"enclosed", label:"Enclosed Collaboration", superGroup:"workspace", color:"#0B5CAB", spaces:[
    ...
    { id:"phone_room",    label:"Phone Room",           type:"non-capacity", sf:50,  isRoomType:true, seatsPerRoom:1,  roomRatio:30,  regionMult:{AMER:1.00,EMEA:0.95,JAPAC:1.00,India:1.10,LATAM:0.90} },
    { id:"phone_room_av", label:"Phone Room (AV)",      type:"non-capacity", sf:60,  isRoomType:true, seatsPerRoom:2,  roomRatio:30,  regionMult:{AMER:1.00,EMEA:1.00,JAPAC:1.00,India:0.90,LATAM:0.90} },
